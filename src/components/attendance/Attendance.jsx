        ...
        <div className="flex flex-wrap items-center gap-5 sm:gap-7">
          ...
          {!hasCheckedIn ? (
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary hover:bg-primary-deep active:scale-[0.98] text-white font-medium text-xs transition-all shadow-xs cursor-pointer disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={isActionLoading}
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border-2 border-primary text-primary hover:bg-primary/5 active:scale-[0.98] font-semibold text-xs transition-all shadow-2xs cursor-pointer disabled:opacity-50"
            >
